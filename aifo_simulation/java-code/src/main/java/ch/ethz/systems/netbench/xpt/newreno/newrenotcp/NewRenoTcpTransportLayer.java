...
import ch.ethz.systems.netbench.xpt.voijslav_and_sppifo.tcp.sphalftcp.SpHalfTcpSocket;
...
//        return null;
    ...
    protected Socket createSocketWithPort(long flowId, int destinationId, long flowSizeByte, int sourcePort, int destinationPort) {
        return new NewRenoTcpSocket(this, flowId, this.identifier, destinationId, flowSizeByte, sourcePort, destinationPort);
